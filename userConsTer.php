        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4> Listes des consultations traitées
                ...
                <div class="card-body"  >
                    ...
                    <table class="table table-bordered table-striped" >
                        ...
                        <?php 
                                    $query = "SELECT * FROM consultation where  etat='terminé' ";
                                    $query_run = mysqli_query($con, $query);
...
$dateTer = $consultation['dateTer']; // Date de terminaison
$timeTer = $consultation['timeTer']; // Heure de terminaison

$timestampTer = strtotime($dateTer . ' ' . $timeTer); // Convertir la date et l'heure de terminaison en timestamp

$currentTimestamp = time(); // Obtenir le timestamp actuel

$elapsedTime = $currentTimestamp - $timestampTer; // Calculer la différence en secondes
...
?>
                                           ...
                                           <a style="font-size: 1rem; background-color: #eee; color: black;"
                                                href="userDétailsTerminer.php?id=<?= $consultation['id']; ?>"
