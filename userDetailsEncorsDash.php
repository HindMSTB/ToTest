        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <a href="indexDashbordUser.php" style="background-color:#ee5c29" class="btn btn-primary float-end"><i class="fas fa-chevron-left"></i></a>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <a
                             href="userModifDashEncours.php?id=<?= $id; ?>" class="btn btn-primary float-end">
                            Modifier</a>
