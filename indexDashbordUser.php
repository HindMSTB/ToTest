...
<div    class="d-flex" id="wrapper">
  ...
  <p class="count"> <?php  echo $nbrNonTraitée[0] ?> </p>
   <a style=" color:#eee;" href="UserNewconsultation.php" >  <p class="count" style="font-size:1rem;">Voir la liste </p> </a>
</div>
  ...
  <p class="count"> <?php  echo $nbrEnCours[0] ?> </p>
   <a style=" color:#eee;" href="userENcoursConsultation.php" > <p class="count" style="font-size:1rem;">Voir la liste </p> </a>
</div>

<div class="box"  style="background-color: #eee;  color:#0f1b6f">
  <h3>Consultations traitées</h3>
  <p class="count"> <?php  echo $nbrTraitée[0] ?> </p>
   <a style=" color:#0f1b6f" href="userConsTer.php" > <p class="count" style="font-size:1rem;">Voir la liste </p></a>
</div>
...
?>                  </td>
                        ...
                        <form action="userTerminerCons.php" method="POST" class="d-inline">
                    ...
                    <i class="fas fa-check"></i>
                                         ...
                                         <a style="font-size: 0.9rem; background-color: #eee; color: black;"
                                                href="userDetailsEncorsDash.php?id=<?= $consultation['id']; ?>"
