        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4>
                    <a href="newConsultation.php" class="btn btn-danger float-end">BACK</a>
                           </h4>
                ...
                <table class="table table-bordered table-striped"  >
                       ...
                       <tr>
                           ...
                           <th>Nombre de consultations en cours de traitement</th>
                               ...
                               if(mysqli_num_rows($query_run) > 0)
                               {
                                 ...
                                 $count = mysqli_fetch_array($query_run);
                                       ...
                                       <td ><?= $users['nom']; ?></td>
                                           ...
                                           <button style="font-size:0.9rem ; background-color:#eee; color:black ;" type="submit" name="aff_Cons" value="<?=$users['nom'];?> "onmouseover="this.style.backgroundColor='green'" onmouseout="this.style.backgroundColor='#eee'"> <i class="fas fa-check"></i></button>
                                          </form>
