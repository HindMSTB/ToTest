        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <a href="EncoursConsultation.php" style="background-color:#ee5c29" class="btn btn-primary float-end"><i class="fas fa-chevron-left"></i></a>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <a
                             href="modifierConsultationEncours.php?id=<?= $id; ?>" class="btn btn-primary float-end">
                            Modifier</a>
...
<button style="font-size:1.2rem ; width:3cm" class="btn btn-danger btn-sm"  type="submit" name="sup_ConsEnC" 
                                ...
                                ?>
                                    <form action="CodeConsultation.php" method="POST" enctype="multipart/form-data">
                                     ...
                                     <div class="mb-3">
                                        ...
                                        <div class="mb-3">
    <label class="form-label">Demandée</label>
