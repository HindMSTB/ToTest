...
<div    class="d-flex" id="wrapper">
    ...
    <li><a href="#" style="font-size: 2.2ch; color:#ee5c29">Listes des consultations <i class="fas fa-caret-down"></i></a>
      <ul class="sub-menu">
        ...
        <li><a href="userConsTe.php">Consultations traitées</a></li>
      </ul>
    </li>
    ...
    <li><a href="#"style="font-size: 2.2ch;color:#ee5c29">Détais <i class="fas fa-caret-down"></i></a>
      <ul class="sub-menu">
        <li><a href=".php">Sur les entreprises</a></li>
        <!--li><a href=".php">Sur les employeurs </a></li-->
      </ul>
    </li>
    </ul>
  </nav>
                        ...
                        <tbody>
                            ...
                            if (mysqli_num_rows($query_run) > 0) {
                                foreach ($query_run as $consultation) {
                                    ...
                                    $query_info = "SELECT num, email FROM consultation  WHERE nomEntreprise = '$entreprise'";
                                    $query_info_run = mysqli_query($con, $query_info);
                                    $entreprise_info = mysqli_fetch_assoc($query_info_run);
                                    $numero_telephone = $entreprise_info['num'];
