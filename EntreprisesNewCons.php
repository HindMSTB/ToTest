        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4> Listes des nouvelles consultations demandée par <?php echo $entreprise; ?>
                ...
                <div class="card-body"  >
                    ...
                    <table class="table table-bordered table-striped" >
                        ...
                        <?php 
                        $query = "SELECT * FROM consultation WHERE etat='Non traitée' AND nomEntreprise='$entreprise'";
...
?>
                                                ...
                                                <td >
                                                 ...
                                                 <!--form action="affectationConsultation.php" method="POST" class="d-inline">

                                                 <a style="font-size:1rem ; background-color:#eee; color:black;"

                                             href="affectationConsultation.php?id=<?= $_SESSION["idCons"]= $consultation['id'];?>" 
                                             
                                                class="btn btn-success btn-sm">  <i class="fas fa-address-book"></i></a>
                                           </form-->

                                                   
                                           <a style="font-size: 1rem; background-color: #eee; color: black;"
                                                href="detailNew.php?id=<?= $consultation['id']; ?>"
